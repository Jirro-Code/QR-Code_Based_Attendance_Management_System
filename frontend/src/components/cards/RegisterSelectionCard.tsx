...
export const SelectionCard = ({ onClose }: SelectionCardProps) => {
    ...
    return (
        <div onClick={onClose} className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4 backdrop-blur-[2px]">
            <div onClick={(e) => e.stopPropagation()} className="flex flex-col items-center gap-4 bg-white p-8 rounded-lg shadow-md max-w-sm w-full">
