...
export const DeleteEventCard = ({ id, onDeleted, setShowNotification, onSetNotif }: DeleteCardEventProps) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col gap-3 max-w-md w-full">
                ...
                <button onClick={() => setShowConfirmation(true)} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded self-start">Delete Event</button>
