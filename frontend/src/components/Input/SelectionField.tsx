...
export const SelectionField = ({ label, id, options, value, onChange, placeholder = "Select an option", isRequired }: SelectionFieldProps) => {
    return (
        <div className="flex flex-col mt-1">
            ...
            <select id={id} name={id} value={value} onChange={onChange} required={isRequired ?? true} className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-slate-400 focus:border-slate-400 text-gray-500">
