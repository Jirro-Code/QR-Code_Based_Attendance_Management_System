    ...
    return (
        <div>
            ...
            <form className="createEventForm" onSubmit={handleSubmit}>
                <Input label="Event Name" type="text" id="eventName" placeholder="Event Name" name="eventName" value={eventName.eventName} onChange={handleChange} />
                <Input label="Event Description" type="text" id="eventDescription" placeholder="Event Description (Optional)" name="eventDescription" value={eventName.eventDescription} onChange={handleChange} isRequired={false} />
                <Input label="Event Date" type="date" id="eventDate" placeholder="Event Date" name="eventDate" value={eventName.eventDate} onChange={handleChange} />
                <Input label="Event Location" type="text" id="eventLocation" placeholder="Event Location" name="eventLocation" value={eventName.eventLocation} onChange={handleChange} />
