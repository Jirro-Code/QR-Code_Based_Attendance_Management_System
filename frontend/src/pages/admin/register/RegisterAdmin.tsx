...
function RegisterAdmin() {  
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const {handleRegister} = useRegister("/admin-login", adminData, setError);
        handleRegister();
    }
        ...
        <div className="registerAdminPage">
            ...
            <div className="registerAdminForm">
                ...
                <form onSubmit={handleSubmit}>
                    <Input label="Admin Name" id="adminName" type="text" placeholder="Admin Name" onChange={handleChange} name="username" />
                    <Input label="Email" id="adminEmail" type="email" placeholder="Email" onChange={handleChange} name="email" />
                    <Input label="Password" id="adminPassword" type="password" placeholder="Password" onChange={handleChange} name="password" />
