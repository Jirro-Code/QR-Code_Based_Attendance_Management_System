...
export const ManageAttendances = () => {
    ...
    const { useViewAllEventsWithAttendanceRecords, useSearchEvents, useViewEventWithAttendanceByStrandAndSection } = useView();
    ...
    const applyAllFilters = async (
        ...
        if (strandFilter || bySection) {
            const filteredEvents = await useViewEventWithAttendanceByStrandAndSection(strandFilter, bySection, false, setError);
